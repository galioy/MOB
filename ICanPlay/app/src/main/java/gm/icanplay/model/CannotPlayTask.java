 ...
 */
public class CannotPlayTask extends AsyncTask<String, String, String> {

    private StartScreen activity;

    public CannotPlayTask(StartScreen _activity) {
    ...
    protected String doInBackground(String... params) {
        ...
        try {
            ...
            ws_url = new URL(feed + "cmd=cannotplay&Name=" + name + "&Groupid=" + group);
